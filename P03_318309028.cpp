...
// Pirámide triangular regular Alrevez
...
int main()
{
	...
	CrearPiramideTriangularAlrevez();//índice 2 en MeshList
	CrearCilindro(50, 1.0f);//índice 3 en MeshList
	CrearCono(3, 1.0f);//índice 4 en MeshList
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		meshList[1]->RenderMesh(); //dibuja las figuras geométricas cilindro, cono, pirámide base cuadrangular
		//sp.render(); //dibuja esfera




		//Piramide triang cara verde claro 1
		{
			model = glm::mat4(1.0f);
			color = glm::vec3(0.15f, 0.8f, 0.55f);
		...
		//Piramide triang cara verde claro 2
		{
			model = glm::mat4(1.0f);
			color = glm::vec3(0.15f, 0.8f, 0.55f);
			//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		...
		//Piramide triang cara verde claro 3
		{
			model = glm::mat4(1.0f);
			color = glm::vec3(0.15f, 0.8f, 0.55f);
			//model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.0f));
		...
		//Piramide triang cara verde claro 4
		{
			model = glm::mat4(1.0f);
			color = glm::vec3(0.15f, 0.8f, 0.55f);
			//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		...
		//Piramide triang cara verde claro 5
		{
		...
		//Piramide triang cara verde claro 6
		{
			model = glm::mat4(1.0f);
			color = glm::vec3(0.15f, 0.8f, 0.55f);
			//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		...
		//Piramide triang cara verde claro 7
		{
			model = glm::mat4(1.0f);
			color = glm::vec3(0.15f, 0.8f, 0.55f);
			//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		...
		//Piramide triang cara verde claro 8
		{
			model = glm::mat4(1.0f);
			color = glm::vec3(0.15f, 0.8f, 0.55f);
			//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		...
		//Piramide triang cara verde claro 9
		{
		...
		//Piramide triang cara naranja 1
		{
		...
		//Piramide triang cara naranja 2
		{
			model = glm::mat4(1.0f);
			color = glm::vec3(1.0f, 0.6f, 0.2f);
			//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		...
		//Piramide triang cara naranja 3
		{
		...
		//Piramide triang cara naranja 4
		{
		...
		//Piramide triang cara naranja 5
		{
		...
		//Piramide triang cara naranja 6
		{
		...
		//Piramide triang cara naranja 7
		{
		...
		//Piramide triang cara naranja 8
		{
		...
		//Piramide triang cara naranja 9
		{
		...
		//Piramide triang caras magenta 1
		{
			model = glm::mat4(1.0f);
		...
		//Piramide triang cara magenta 2
		{
			model = glm::mat4(1.0f);
			color = glm::vec3(1.0f, 0.0f, 1.0f);
			//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		...
		//Piramide triangular cara magenta 3
		{
			model = glm::mat4(1.0f);
			color = glm::vec3(1.0f, 0.0f, 1.0f);
			//model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.0f));
		...
		//Piramide triang cara magenta 4
		{
			model = glm::mat4(1.0f);
			color = glm::vec3(1.0f, 0.0f, 1.0f);
			//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		...
		//Piramide triang cara magenta 5
		{
		...
		//Piramide triang cara magenta 6
		{
			model = glm::mat4(1.0f);
			color = glm::vec3(1.0f, 0.0f, 1.0f);
			//model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.0f));
		...
		//Piramide triang cara magenta 7
		{
		...
		//Piramide triang cara magenta 8
		{
			model = glm::mat4(1.0f);
			color = glm::vec3(1.0f, 0.0f, 1.0f);
			//Opcional duplicar esta traslación inicial para posicionar en -Z a los objetos en el mismo punto
		...
		//Piramide triang cara magenta 9
		{

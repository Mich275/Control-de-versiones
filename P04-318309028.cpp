	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Grúa
		{
			...
			{
				//base ruedas
				color = glm::vec3(0.44f, 0.48f, 0.48f);
			...
			//brazo 1 se mueve con f
			model = glm::translate(model, glm::vec3(0.0f, -2.5f, 0.0f));
			modelaux = model;
			model = glm::scale(model, glm::vec3(1.0f, 5.0f, 1.0f));
			glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
			color = glm::vec3(0.95f, 0.81f, 0.24f);
			glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
			...
			//brazo 2 se mueve con g
			model = glm::translate(model, glm::vec3(0.0f, -2.5f, 0.0f));
			modelaux = model;
			model = glm::scale(model, glm::vec3(1.0f, 5.0f, 1.0f));
			glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
			color = glm::vec3(0.60f, 0.34f, 0.71f);
			glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
			meshList[0]->RenderMesh(); //dibuja cubo y pirámide triangular
			model = modelaux;
			...
			//brazo 3 se mueve con h
			model = glm::translate(model, glm::vec3(0.0f, -2.5f, 0.0f));
			modelaux = model;
			model = glm::scale(model, glm::vec3(1.0f, 5.0f, 1.0f));
			glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
			color = glm::vec3(0.36f, 0.67f, 0.88f);
			glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
			meshList[0]->RenderMesh(); //dibuja cubo y pirámide triangular
			model = modelaux;
		...
		//Animal
		{
			...
			// 
			//Cuerpo perrito
			model = glm::translate(model, glm::vec3(17.0f, 0.0f, -4.0f));
			...
			glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
			glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
			color = glm::vec3(0.58f, 0.64f, 0.65f);
			glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
			sp.render();
			//para descartar la escala que no quiero heredar se carga la información de la matrix auxiliar
			model = modelaux;

			//Pata 1 adeante izquierda 
			{
				//articulación 1 
				...
				model = glm::scale(model, glm::vec3(1.0f, 1.0f, 0.5f));
				color = glm::vec3(0.68f, 0.83f, 0.94f);
				glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
				glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
				sp.render();
				model = modelaux2;
			...
			//Parte de la cabeza 
			{
				...
				model = glm::scale(model, glm::vec3(1.0f, 3.0f, 0.8f));
				glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
				color = glm::vec3(0.58f, 0.64f, 0.65f);
				glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
				meshList[0]->RenderMesh(); //dibuja cubo y pirámide triangul
				...
				//ojo 1
				model = modelaux2;
				model = glm::translate(model, glm::vec3(-2.5f, 0.4f, -0.4f));
				...
				//oreja 1
				model = modelaux2;
				model = glm::translate(model, glm::vec3(-0.9f, -0.2f, -1.3f));
				model = glm::rotate(model, glm::radians(87.0f), glm::vec3(0.0f, 0.0f, 1.0f));
				model = glm::scale(model, glm::vec3(2.0f, 1.2f, 0.5f));
				color = glm::vec3(0.0f, 0.0f, 0.0f);
				glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
				glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
				sp.render();
			...
			//Cola
			{
				...
				model = glm::scale(model, glm::vec3(1.52f, 3.0f, 1.2f));
				glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
				color = glm::vec3(0.58f, 0.64f, 0.65f);
				glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
